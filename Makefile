...
PROJECT_NAME := provider-confluentcloud
...
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-confluent_1.32.0
...
xpkg.build.provider-confluentcloud: do.build.images
